...
@Obfuscate
public class PantherPrefs {
    private static final String KEY_ALIAS = "DarkPantherStoreV1";
    private static final String PREFIX = "K1:";

    public Context context;
    private final SharedPreferences sp;

    public PantherPrefs(Context context) {
    ...
    public String getSt(String map, String ori) { return reveal(sp.getString(map, null), ori); }
    public void setSt(String map, String write) {
        String encrypted = protect(write);
        if (encrypted != null) sp.edit().putString(map, encrypted).apply();
    }
    public boolean getBool(String map, boolean ori) { return sp.getBoolean(map, ori); }
    public void setBool(String map, boolean write) { sp.edit().putBoolean(map, write).apply(); }
    public int getInt(String map, int ori) { return sp.getInt(map, ori); }
    public void setInt(String map, int write) { sp.edit().putInt(map, write).apply(); }
    ...
    public void setSt(String file, String map, String write) {
        String encrypted = protect(write);
        if (encrypted != null) context.getSharedPreferences(file, Context.MODE_PRIVATE).edit().putString(map, encrypted).apply();
    }
    public String getSt(String file, String map, String ori) {
        return reveal(context.getSharedPreferences(file, Context.MODE_PRIVATE).getString(map, null), ori);
    }
    ...
    public void setLocale(Activity act, String cd) { setLocaleInternal(act.getResources(), cd); }
    public void setLocale(Service act, String cd) { setLocaleInternal(act.getResources(), cd); }
    private void setLocaleInternal(Resources resources, String cd) {
