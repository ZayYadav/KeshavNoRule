...
@Obfuscate
public class ParallaxLoader2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prefs = new ParallaxLoader6(this);
        ...
        if (getKey != null) {
            ParallaxLoader7.applyTouchBounce(getKey, () -> {
                try {
        ...
        // Action: Login Button
        if (btnLogin != null) {
            ParallaxLoader7.applyTouchBounce(btnLogin, () -> {
        ...
        // Action: Paste Button
        if (pasteBtn != null) {
            ParallaxLoader7.applyTouchBounce(pasteBtn, () -> {
                ...
                if (clipboard != null && clipboard.hasPrimaryClip()) {
                    ...
                    if (clip != null && clip.getItemCount() > 0) {
                        ...
                        if (pasted.length() > 3) {
                            ParallaxLoader7.getInstance().playPaste();
    ...
    private void Login(final Context m_Context, final String userKey) {
        ...
        Handler loginHandler = new Handler(Looper.getMainLooper(), msg -> {
            ...
            if (msg.what == 0) {
                ...
                ParallaxLoader7.getInstance().playSuccess();
    ...
    private void startDownload(Context m_Context) {
        ...
        ParallaxLoader5 task = new ParallaxLoader5(ParallaxLoader2.this, success -> {
            dismissLoadingDialog();

            if (!success) {
                ParallaxLoader9.showIntegrityFailure(
                        ParallaxLoader2.this,
                        "The trusted server loader could not be verified or securely bound.");
                return;
            }

            if (!ParallaxLoader8.verify(ParallaxLoader2.this)) {
                ParallaxLoader9.showIntegrityFailure(
                        ParallaxLoader2.this,
            ...
            Intent i = new Intent(m_Context, ParallaxLoader3.class);
        ...
        try {
            task.execute(ParallaxLoader5.Link());
        } catch (Throwable ignored) {
            ParallaxLoader9.showIntegrityFailure(
                    ParallaxLoader2.this,
