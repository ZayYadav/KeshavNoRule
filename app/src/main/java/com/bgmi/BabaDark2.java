...
import com.bgmi.utils.BabaDark5;
import com.bgmi.utils.BabaDark6;
import com.bgmi.utils.BabaDark7;

import org.lsposed.lsparanoid.Obfuscate;

@Obfuscate
public class BabaDark2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Animated Floating Glow on Title "BABA DARK LOADER"
        ...
        if (getKey != null) {
            BabaDark7.applyTouchBounce(getKey, () -> {
                try {
        ...
        // Action: Login Button
        if (btnLogin != null) {
            BabaDark7.applyTouchBounce(btnLogin, () -> {
        ...
        // Action: Paste Button
        if (pasteBtn != null) {
            BabaDark7.applyTouchBounce(pasteBtn, () -> {
                ...
                if (clipboard != null && clipboard.hasPrimaryClip()) {
                    ...
                    if (clip != null && clip.getItemCount() > 0) {
                        ...
                        if (pasted.length() > 3) {
                            BabaDark7.getInstance().playPaste();
    ...
    private void Login(final Context m_Context, final String userKey) {
        ...
        Handler loginHandler = new Handler(Looper.getMainLooper(), msg -> {
            ...
            if (msg.what == 0) {
                ...
                BabaDark7.getInstance().playSuccess();
    ...
    private void startDownload(Context m_Context) {
        ...
        BabaDark5 task = new BabaDark5(BabaDark2.this, success -> {
            dismissLoadingDialog();
            ...
            if (!BabaDark8.verify(BabaDark2.this)) {
                BabaDark9.showIntegrityFailure(
                        BabaDark2.this,
            ...
            Intent i = new Intent(m_Context, BabaDark3.class);
