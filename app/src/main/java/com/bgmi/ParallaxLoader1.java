...
@Obfuscate
public class ParallaxLoader1 extends Application {
    ...
    private static final String TAG = "ParallaxLoader1";
    ...
    private static void loadTrustedServerLoader(
        ...
        try {
            File loader = ParallaxLoader5.trustedLoaderFile(hostContext);
