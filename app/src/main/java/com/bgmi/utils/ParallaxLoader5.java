...
public class ParallaxLoader5 extends AsyncTask<String, Integer, String> {

    private static final String TAG = "ParallaxLoader5";
    ...
    public ParallaxLoader5(Context context) {
        this(context, null);
    }

    public ParallaxLoader5(Context context, Callback callback) {
