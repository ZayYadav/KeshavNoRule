...
public class BabaDark5 extends AsyncTask<String, Integer, String> {

    private static final String TAG = "BabaDark5";
    ...
    public BabaDark5(Context context) {
        this(context, null);
    }

    public BabaDark5(Context context, Callback callback) {
