...
@Obfuscate
public class ParallaxLoader7 {

    private static volatile ParallaxLoader7 instance;
    ...
    private ParallaxLoader7() {}

    public static ParallaxLoader7 getInstance() {
        if (instance == null) {
            synchronized (ParallaxLoader7.class) {
                if (instance == null) {
                    instance = new ParallaxLoader7();
                }
            }
        }
        return instance;
