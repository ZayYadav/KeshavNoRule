...
public class TeamDark5 extends AsyncTask<String, Integer, String> {

    private static final String TAG = "TeamDark5";
    ...
    private static final String PREF_NAME = "com.team.dark.download";
    private static final String PREF_VERSION_KEY = "version";
    private static final String ZIP_NAME = "imgui.zip";

    public TeamDark5(Context context) {
        this(context, null);
    }

    public TeamDark5(Context context, Callback callback) {
